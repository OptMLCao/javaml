...
public class GridSearch {
     ...
     *
     * @param classifier The <code>Classifier</code>,
     * @param dataset    the <code>DataSet</code>,
     * @param folds      and the number of folds used for cross validation.
     */
     ...
     *
     * @param param This settings are used to configure the classifier.
     * @param C     An array of values for the C parameter
     * @param gamma An array of values for the gammy parameter
     ...
     *
     * @param CIndex     The index that points to a position of the C-Array
     * @param gammaIndex The index that points to a position of the gamma-Array
     */
