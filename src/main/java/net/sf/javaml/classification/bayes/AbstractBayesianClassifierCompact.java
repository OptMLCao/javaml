 ...
 */
public class AbstractBayesianClassifierCompact extends AbstractClassifier {
     ...
     *
     * @param lap    laplace correction
     * @param log    logarithmic results to avoid rounding results to zero because
     *               of limited computer precision
     * @param sparse sparseness of used dataset
     */
    public AbstractBayesianClassifierCompact(boolean lap, boolean log,
                                             boolean sparse) {
     ...
     *
     * @param Instances2Train The trainingData examples from which class priors will be
     *                        estimated
     */
     ...
     * different classes
     *
     * @param Instances2Train The trainingData examples from which counts will be estimated
     */
     ...
     *
     * @param topology_element current feature being handled
     * @param inst             current Instance being handled
     */
     ...
     *
     * @param distribution class score distribution during classification process
     */
