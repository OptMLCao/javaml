...
public class KDependentBayesClassifier extends AbstractBayesianClassifier {
     ...
     *
     * @param sparse   sparseness of dataset
     * @param treshold KDB CMI treshold
     * @param kparents a list of ASC SORTED k values
     */
     ...
     *
     * @param testExample The retrieveInstanceIDList example to be categorized
     */
     ...
     * @param FV feature value
     * @param CV class value
     */
