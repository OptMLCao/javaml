...
public class DensityBasedSpatialClustering extends AbstractDensityBasedClustering implements Clusterer {
     ...
     *
     * @param epsilon   epsilon range query parameter
     * @param minPoints the minimum number of points that should fall within the
     *                  epsilon range query
     */
     ...
     * Create a new Density based clusterer with the provided parameters.
     *
     * @param epsilon   the epsilon value for the epsilon range query to determining
     *                  whether the density is high engou
     * @param minPoints the minimum number of points that should fall within the
     *                  epsilon range query.
     * @param dm        the distance measure to use for the epsilon range query.
     */
     ...
     *
     * @param instance The DataObject that needs to be assigned
