...
public class KMedoids implements Clusterer {
     ...
     * @param maxIterations    the maximum number of iteration the algorithm is allowed to
     *                         run
     * @param DistanceMeasure  dm the distance metric to use for measuring the distance
     *                         between instances
     */
     ...
     *
     * @param medoids   the current set of cluster medoids, will be modified to fit
     *                  the new assignment
     * @param assigment the new assignment of all instances to the different medoids
     * @param output    the cluster output, this will be modified at the end of the
     *                  method
     * @return the
     */
