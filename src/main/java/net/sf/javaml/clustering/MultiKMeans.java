 ...
 * @param iterations the number of iterations in SKM
 * @param repeats    the number of SKM repeats
 * @param dm         distance measure used for internal cluster evaluation
 * @param ce         clusterevaluation methode used for internal cluster evaluation
 * @author Thomas Abeel
