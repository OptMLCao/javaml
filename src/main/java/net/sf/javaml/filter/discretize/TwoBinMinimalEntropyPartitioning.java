...
import net.sf.javaml.classification.bayes.AbstractBayesianClassifierCompact;
...
public class TwoBinMinimalEntropyPartitioning extends AbstractFilter {
	...
	private AbstractBayesianClassifierCompact abc_compact;
	...
	private void determineBorders(Dataset data, boolean sparse) {
		...
		// featurevalues
		abc_compact = new AbstractBayesianClassifierCompact(true, false,
				sparse);
